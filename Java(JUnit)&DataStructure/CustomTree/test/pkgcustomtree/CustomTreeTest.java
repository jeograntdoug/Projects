...
import pkgcustomtree.CustomTree;
import pkgcustomtree.DuplicateValueException;
import pkgcustomtree.CustomTree.Node;
import pkgcustomtree.CustomTree.NodeModificationObserver;
...
public class CustomTreeTest {
    CustomTree<String,Integer> tree;
    
    @Before
    public void setUp() {
        tree = new CustomTree<String,Integer>();
    }
...
//    }
    ...
    public void isDuplicateValueExceptionThrownWithNode(){
        try {
            ...
            CustomTree.Node node = (CustomTree.Node)ex.getNode();
    ...
    @Test
    //FIXME: find how can test observer properly
